 ...
 */
public class FrmDeleteExercicio extends javax.swing.JFrame {

    /**
     * Creates new form FrmDeleteExercicio
     */
    public FrmDeleteExercicio() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jp_Main.setBorder(javax.swing.BorderFactory.createTitledBorder("Exclusão de Exercícios"));

        jl_Name.setText("Nome do Exercício a Ser Excluído");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmDeleteExercicio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmDeleteExercicio().setVisible(true);
            }
        });
    }
